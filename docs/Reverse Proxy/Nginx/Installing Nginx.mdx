...
:::note
You can find example `.conf` files [HERE](https://docs.bankai-tech.com/Examples/Reverse%20Proxies/Nginx/)
:::
...
If using HTTPS (recommended), You will need to grab SSL certificates from Cloudflare using Certbot. You can find documentation [here](https://docs.bankai-tech.com/Reverse%20Proxy/Introduction)
## Conclusion
