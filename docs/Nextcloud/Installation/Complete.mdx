...
:::note
Before proceeding, you will need to configure your reverse proxy. I have an example Nginx config [Here](https://docs.bankai-tech.com/Examples/Reverse%20Proxies/Nginx/).
:::
<p>
