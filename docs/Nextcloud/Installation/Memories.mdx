...
```editorconfig title="Highlighted items will need to be modified" (1,2,4,9} showLineNumbers
...
```
Paste the Following with `CNTRL+SHIFT+V`
```editorconfig title="Highlighted items will need to be modified" (1,2} showLineNumbers
...
```
Paste the Following with `CNTRL+SHIFT+V`
```editorconfig title="Highlighted items will need to be modified" (1} showLineNumbers
